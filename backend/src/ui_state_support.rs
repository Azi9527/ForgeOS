        ...
        for (key, entry) in entries {
            ...
            folders.insert(
                ...
                json!({
                    ...
                    "rootPath": entry.get("rootPath").cloned().unwrap_or(Value::Null),
                    "repoPath": entry.get("repoPath").cloned().unwrap_or(Value::Null),
                    "lastSessionId": entry.get("lastSessionId").cloned().unwrap_or(Value::Null),
                    "lastOpenedAt": entry.get("lastOpenedAt").cloned().unwrap_or(Value::Null),
