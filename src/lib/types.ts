...
export type ProjectSessionSettings = {
  model: string | null;
};
...
export type ProjectValidationEvidence = ProjectValidationCheck & {
...
export type ProjectArtifact = {
  ...
  signatureAlgorithm?: "hmac-sha256" | string | null;
  signatureVerified?: boolean;
  status: "draft" | "ready" | "retired";
  createdAt: number;
  createdBy: ProjectLifecycleOperator | null;
};

export type ProjectReleaseApproval = ProjectLifecycleOperator & { approvedAt: number };

export type ProjectRelease = {
  id: string;
  version: string;
  artifactIds: string[];
  status: "draft" | "awaitingApproval" | "approved" | "released" | "rolledBack";
...
export type ProjectEnvironment = {
  ...
  adapter?: "localCommand" | "githubActions";
