          ...
          <div class="space-y-6">
            ...
            <section class="console-panel">
              ...
              <div class="divide-y divide-slate-100">
                {#each orderedProjects.slice(0, 5) as project (project.name)}
